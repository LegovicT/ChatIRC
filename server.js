...
io.on('connection', (socket) => {
    ...
    socket.on('newPseudo', (pseudo, newPseudo) => {
        console.log("update pseudo: " + pseudo + " to " + newPseudo);
    ...
    function _updatePseudo(pseudo, newPseudo) {
        //alert(pseudo + ' ' + newPseudo);
        //mongoose.connect('mongodb://localhost/Chat', { useNewUrlParser: true, useUnifiedTopology: true }, function(err, db){
        // mongoose.connect("mongodb://localhost/Chat", function(error, db) {
